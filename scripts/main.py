...
def wrapper_scan(req):
    ...
    try:
        ...
        print "TreeD failed to produce readable image"
        return WrapperScanResponse(None, 4, "The pcd file generated by the hardware couldn't be read.")

    # Check that there are enough points
    minimum_size = 50
    if points.size < minimum_size:
        return WrapperScanResponse(None, 5, "Not enough points only " + str(points.size) +
